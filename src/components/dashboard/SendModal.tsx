          ...
          <div className="bg-gradient-to-br from-slate-900/90 to-red-900/20 border border-red-500/30 rounded-2xl p-8 max-w-md w-full backdrop-blur-md shadow-2xl">
            ...
            <div className="relative text-center">
              ...
              <p className="text-red-200 mb-6">
                Wallet address not available. Please
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 overflow-y-auto">
      <div className="min-h-screen flex items-center justify-center p-4 py-8">
        <div className="bg-gradient-to-br from-slate-900/95 to-purple-900/20 border border-purple-500/30 rounded-2xl max-w-lg w-full backdrop-blur-md shadow-2xl shadow-purple-500/10 overflow-hidden my-4">
            ...
            >
              ...
              <div className="text-center">
                <div className="flex items-center justify-center gap-2 text-xs text-slate-500">
                  ...
                  <span>
                    Transaction will be processed securely
                    on the blockchain
                  </span>
                </div>
              </div>
